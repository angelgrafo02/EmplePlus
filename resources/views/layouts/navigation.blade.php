    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    @can('create',\App\Models\Vacante::class)
                        <a class="text-white mr-2 w-7 h-7 bg-indigo-600 hover:bg-indigo-800 rounded-full flex flex-col justify-center items-center text-sm font-extrabold"
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                @if(auth()->user()->rol===2)
                    <div class="flex gap-2 items-center p-3">
                        <a class="text-white w-7 h-7 bg-indigo-600 hover:bg-indigo-800 rounded-full flex flex-col justify-center items-center"
                           href="{{route('notificaciones')}}">
                            {{auth()->user()->unreadNotifications->count()}}
                        </a>
                        <p class="dark:text-gray-400 font-medium">
