                    ...
                    <div class="md:flex md:justify-center p-5">
                        <ul class="divide-y divide-gray-200 w-full">
                            ...
                            <li class="p-3 flex items-center">
                                <div class="flex-1">
                                        <p class="text-xl font-medium text-gray-100">{{$candidato->user->name}}</p>
                                        <p class=" text-gray-300">{{ $candidato->user->email }}</p>
                                        <p class=" text-gray-300">
                                            Fecha de inscripción: <span class="font-normal">{{ $candidato->created_at->diffForHumans() }}</span>
                                        </p>
                                </div>

                                <div>
                                    <a 
                                        class="inline-flex items-center shadow-sm px-2.5 py-0.5 border border-gray-500 
